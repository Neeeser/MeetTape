...
| A chunk that loops one phrase is a failed chunk, and the last attempt drops it | Six of sixteen ES2003a chunks returned the same fabricated paragraph on sparse audio: 438 invented words against a 386-word reference and 193% DER, reported as success. A deterministic decoder loops again, so failing forever would cost the meeting rather than the window |
