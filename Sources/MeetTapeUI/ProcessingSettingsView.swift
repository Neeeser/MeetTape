    ...
    var body: some View {
        Picker("Model", selection: Binding(
            ...
            choice(
                ...
                "Lowest word error rate measured here: it won all 14 meetings of "
                    + "the benchmark. Word timings built in, 25 languages. 460 MB."
            )
            choice(
                .cohere, "Cohere Transcribe",
                "Ranks higher than Parakeet on published leaderboards and "
                    + "measured worse over the same 14 meetings here. 2.1 GB plus "
                    + "a 600 MB aligner for word timings; the first use takes a "
